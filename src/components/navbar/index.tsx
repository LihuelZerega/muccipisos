        ...
        <div className={`transition-all duration-300 ${menuOpen ? "block" : "hidden"} md:block`}>
          <div className="py-2 md:py-0 flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
            ...
            <div className="relative block sm:hidden">
              ...
              >
                Servicios
                <svg className={`size-4 ms-auto transform transition-transform ${dropdownOpen ? "-rotate-180" : "rotate-0"}`} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="m6 9 6 6 6-6" />
                </svg>
              </button>
              ...
              {dropdownOpen && (
                <div className="relative w-full md:w-52 bg-white md:rounded-lg md:shadow-md p-2">
                  <a className="p-2 block text-sm text-gray-800 hover:bg-gray-100 rounded-lg" href="#servicios" onClick={() => setMenuOpen(false)}>
            ...
            <a className="p-2 flex items-center text-sm text-gray-800 hover:bg-gray-100 rounded-lg transition delay-50 duration-300 ease-in-out" href="#sobre-nosotros" onClick={() => setMenuOpen(false)}>Sobre Nosotros</a>

            <a className="p-2 flex items-center text-sm text-gray-800 hover:bg-gray-100 rounded-lg transition delay-50 duration-300 ease-in-out" href="#contacto" onClick={() => setMenuOpen(false)}>Contacto</a>
            ...
            <div className="flex flex-wrap items-center gap-x-1.5">
              <a className="px-3 py-2 inline-flex items-center font-semibold text-sm rounded-lg bg-mucci-marron text-white hover:bg-yellow-950 focus:outline-none focus:bg-yellow-950 disabled:opacity-50 disabled:pointer-events-none transition delay-50 duration-300 ease-in-out" href="#">
                Pedir Presupuesto
              </a>
            </div>
          </div>
